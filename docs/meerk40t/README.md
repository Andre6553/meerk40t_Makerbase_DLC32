...
- **[15-meerkat-local-changes.md](15-meerkat-local-changes.md)** — changelog of fork-style GUI and rule updates (Plan Export SD-ready LF/M3, ESP3D filename dialog, GRBL false-connect / sync-mode fix, Laser-Control progress bar, tree op double-click → Parameter-Test, GRBL overrides, 2026).
