...
**Current fork:** [Andre6553/meerk40t](https://github.com/Andre6553/meerk40t) — latest entry **v0.9.9040**. Canonical copy also lives at [docs/meerk40t/15-meerkat-local-changes.md](docs/meerk40t/15-meerkat-local-changes.md) (keep in sync when editing). The same changelog is on the [fork README](https://github.com/Andre6553/meerk40t#fork-changelog-meerk40t).
